...
2. Once a model is trained, any new anndata object can be processed. 
   ...
   the quality of the generated features.
...
3. Finally, we evaluate the quality of the features.
   To this end we use the annotations to predict the gene expression profile
...
Finally, evaluate the features based on their abalitily to predict the gene expression profile.
...
You can do this by using `cromwell <https://cromwell.readthedocs.io/en/stable/>`_:
